...
<title>Военный учебный центр</title>
				...
				<div class="row">
					<div class="col">
						<div class="avatar-wrapper">
							<div class="title">
								<h1>Военный учебный центр</h1>
							</div>
							<img src="../taplink/img/avatar/military_center_linktree.webp" alt="Военный учебный центр">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="container">
				<div class="row flex hcenter">
						...
						<div class="col xl4 l6 m6">
							<a href="https://kubsau.ru/education/military/" class="bttn-big" id="kubsau" target="_blank" rel="nofollow">
					...
					<div class="col xl4 l6 m6">
						<a href="https://vk.com/uvckgau" class="bttn-big" id="vk" target="_blank" rel="nofollow">
							<span class="prefix">
