...
<title>Факультет заочного обучения</title>
				...
				<div class="row">
					<div class="col">
						<div class="avatar-wrapper">
							<div class="title">
								<h1>Факультет заочного обучения</h1>
							</div>
							<img src="../taplink/img/avatar/zaochka_linktree.webp" alt="Факультет заочного обучения">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="container">
				<div class="row flex hcenter">
						...
						<div class="col xl4 l6 m6">
							<a href="https://kubsau.ru/education/fzo/" class="bttn-big" id="kubsau" target="_blank" rel="nofollow">
					...
					<div class="col xl4 l6 m6">
						<a href="https://vk.com/fzokubsau" class="bttn-big" id="vk" target="_blank" rel="nofollow">
							<span class="prefix">
