				...
				<div class="row">
					<div class="col">
						<div class="avatar-wrapper">
							...
							<img src="../taplink/img/avatar/priemka_linktree.webp" alt="Приёмная комиссия">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="container">
				<div class="row flex hcenter">
						...
						<div class="col xl4 l6 m6">
							<a href="https://kubsau.ru/" class="bttn-big" id="kubsau" target="_blank" rel="nofollow">
					...
					<div class="col xl4 l6 m6">
						<a href="https://vk.com/priemkubsau" class="bttn-big" id="vk" target="_blank" rel="nofollow">
							<span class="prefix">
					...
					<div class="col xl4 l6 m6">
						<a href="tg://resolve?domain=priemkubsau" class="bttn-big" id="tg" target="_blank" rel="nofollow">
							<span class="prefix">
