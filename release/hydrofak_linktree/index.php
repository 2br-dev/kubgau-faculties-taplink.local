...
<title>Факультет гидромелиорации</title>
				...
				<div class="row">
					<div class="col">
						<div class="avatar-wrapper">
							<div class="title">
								<h1>Факультет гидромелиорации</h1>
							</div>
							<img src="../taplink/img/avatar/hydrofak_linktree.webp" alt="Факультет гидромелиорации">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="container">
				<div class="row flex hcenter">
						...
						<div class="col xl4 l6 m6">
							<a href="https://kubsau.ru/education/faculties/vodnogo-khozyaystva/" class="bttn-big" id="kubsau" target="_blank" rel="nofollow">
					...
					<div class="col xl4 l6 m6">
						<a href="https://vk.com/gidrofak_kubsau" class="bttn-big" id="vk" target="_blank" rel="nofollow">
							<span class="prefix">
