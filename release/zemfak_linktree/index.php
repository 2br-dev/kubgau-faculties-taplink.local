...
<title>Землеустроительный факультет</title>
				...
				<div class="row">
					<div class="col">
						<div class="avatar-wrapper">
							<div class="title">
								<h1>Землеустроительный факультет</h1>
							</div>
							<img src="../taplink/img/avatar/zemfak_linktree.webp" alt="Землеустроительный факультет">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="container">
				<div class="row flex hcenter">
						...
						<div class="col xl4 l6 m6">
							<a href="https://kubsau.ru/education/faculties/zemleustroitelnyy/" class="bttn-big" id="kubsau" target="_blank" rel="nofollow">
					...
					<div class="col xl4 l6 m6">
						<a href="https://vk.com/izffkubsau" class="bttn-big" id="vk" target="_blank" rel="nofollow">
							<span class="prefix">
