...
<title>Учётно-финансовый факультет</title>
				...
				<div class="row">
					<div class="col">
						<div class="avatar-wrapper">
							<div class="title">
								<h1>Учётно-финансовый факультет</h1>
							</div>
							<img src="../taplink/img/avatar/uchfin_linktree.webp" alt="Учётно-финансовый факультет">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="container">
				<div class="row flex hcenter">
						...
						<div class="col xl4 l6 m6">
							<a href="https://kubsau.ru/education/faculties/uchetno-finansovyy/" class="bttn-big" id="kubsau" target="_blank" rel="nofollow">
					...
					<div class="col xl4 l6 m6">
						<a href="https://vk.com/uffkubsau" class="bttn-big" id="vk" target="_blank" rel="nofollow">
							<span class="prefix">
