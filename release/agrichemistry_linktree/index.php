...
<title>Факультет агрохимии и защиты растений</title>
				...
				<div class="row">
					<div class="col">
						<div class="avatar-wrapper">
							<div class="title">
								<h1>Факультет агрохимии и защиты растений</h1>
							</div>
							<img src="../taplink/img/avatar/agrichemistry_linktree.webp" alt="Факультет агрохимии и защиты растений">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="container">
				<div class="row flex hcenter">
						...
						<div class="col xl4 l6 m6">
							<a href="https://kubsau.ru/education/faculties/agrokhimii/" class="bttn-big" id="kubsau" target="_blank" rel="nofollow">
					...
					<div class="col xl4 l6 m6">
						<a href="https://vk.com/hp_rz_kubsau" class="bttn-big" id="vk" target="_blank" rel="nofollow">
							<span class="prefix">
