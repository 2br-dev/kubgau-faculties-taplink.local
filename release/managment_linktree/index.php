				...
				<div class="row">
					<div class="col">
						<div class="avatar-wrapper">
							<div class="title">
								<h1>Факультет управления</h1>
							</div>
							<img src="../taplink/img/avatar/managment_linktree.webp" alt="Факультет управления">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="container">
				<div class="row flex hcenter">
						...
						<div class="col xl4 l6 m6">
							<a href="https://kubsau.ru/education/faculties/upravleniya/" class="bttn-big" id="kubsau" target="_blank" rel="nofollow">
					...
					<div class="col xl4 l6 m6">
						<a href="https://vk.com/gmukubsau" class="bttn-big" id="vk" target="_blank" rel="nofollow">
							<span class="prefix">
					...
					<div class="col xl4 l6 m6">
						<a href="https://t.me/gmukubsau" class="bttn-big" id="tg" target="_blank" rel="nofollow">
							<span class="prefix">
